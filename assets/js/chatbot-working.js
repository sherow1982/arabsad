...
class ArabSadAIChatbot {
  ...
  generateSmartResponse(message) {
    ...
    const knowledgeBase = [
      {
        keywords: ['سعر', 'تكلفة', 'ميزانية', 'فلوس', 'بكام', 'اسعار'],
      ...
      {
        keywords: ['جوجل', 'google', 'بحث', 'search', 'يوتيوب'],
        response: '🎯 إعلانات Google هي تخصصنا! نضمن لك الظهور في الصفحة الأولى للعملاء الباحثين عن خدماتك. هل لديك موقع إلكتروني حالياً؟',
        actions: [{ text: 'خدمة Google Ads', url: '/arabsad/services/google-ads.html', target: '_blank' }]
      },
      {
        keywords: ['سوشيال', 'فيس', 'انستا', 'سناب', 'تيك توك', 'social', 'facebook', 'instagram'],
        response: '📱 ندير حملاتك على جميع المنصات (Facebook, Instagram, TikTok, Snapchat). نركز على زيادة المبيعات وليس فقط اللايكات.',
        actions: [{ text: 'خدمات السوشيال', url: '/arabsad/services/social-media-ads.html', target: '_blank' }]
      },
      {
        keywords: ['سيو', 'seo', 'تصدر', 'مجاني', 'زيارات'],
      ...
      {
        keywords: ['متجر', 'سلة', 'زد', 'شوبيفاي', 'ecommerce', 'بيع'],
        response: '🛒 نبني متاجر إلكترونية احترافية ونقوم بتسويقها لزيادة المبيعات (ROAS). هل تبيع منتجات ملموسة أم رقمية؟',
        actions: [{ text: 'خدمة المتاجر', url: '/arabsad/services/ecommerce.html', target: '_blank' }]
      },
      {
        keywords: ['تصميم', 'موقع', 'ويب', 'web', 'design'],
        response: '💻 نصمم مواقع تعريفية تعكس هوية شركتك وتكون سريعة ومتجاوبة مع الجوال.',
        actions: [{ text: 'تصميم المواقع', url: '/arabsad/services/website-design.html', target: '_blank' }]
      },
      {
        keywords: ['سعودية', 'رياض', 'جدة', 'saudi', 'ksa'],
        response: '🇸🇦 لدينا خبرة واسعة في السوق السعودي ونفهم سلوك المستهلك هناك جيداً.',
        actions: [{ text: 'خدمات السعودية', url: '/arabsad/sa.html', target: '_blank' }]
      },
      {
        keywords: ['امارات', 'دبي', 'uae', 'dubai'],
        response: '🇦🇪 نقدم خدمات تسويق راقية تناسب المنافسة العالية في سوق الإمارات ودبي.',
      ...
      {
        keywords: ['قطر', 'qatar'],
        response: '🇶🇦 خدمات تسويقية متكاملة للشركات في الدوحة وقطر.',
      ...
      {
        keywords: ['ضمان', 'نتيجة'],
        response: '✅ نعم، نلتزم بمؤشرات أداء (KPIs) واضحة. إذا لم نحقق النتائج المتفق عليها، نراجع الخطة ونحسنها مجاناً.',
        actions: [{ text: 'تحدث مع المدير', url: 'https://wa.me/201110760081', target: '_blank' }]
      },
      {
        keywords: ['من انتم', 'من أنتم', 'شركة', 'مؤسسة'],
        response: '🏢 نحن "مؤسسة إعلانات العرب"، وكالة تسويق رقمي متخصصة في تنمية الأعمال في الخليج العربي ومصر.',
    ...
    return {
      message: 'عذراً، لم أفهم تماماً. هل يمكنك الاختيار من القائمة أدناه أو التواصل معنا مباشرة؟ 👇',
      actions: this.cfg.ctas
    };
  }
